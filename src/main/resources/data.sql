...
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(2, '08:00:00', '17:00:00', true, 'ecoponto.bucarein@joinville.sc.gov.br');

-- 3. Ecoponto Aventureiro - sem coleta
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(3, '07:30:00', '16:30:00', false, 'ecoponto.aventureiro@joinville.sc.gov.br');

-- 4. Ecoponto Floresta
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(4, '08:00:00', '18:00:00', true, 'ecoponto.floresta@joinville.sc.gov.br');

-- 5. Ecoponto Boa Vista
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(5, '07:00:00', '17:00:00', false, 'ecoponto.boavista@joinville.sc.gov.br');

-- 6. Ecoponto Glória
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(6, '08:00:00', '17:00:00', true, 'ecoponto.gloria@joinville.sc.gov.br');

-- 7. Ecoponto Iririú
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(7, '07:00:00', '16:00:00', false, 'ecoponto.iririu@joinville.sc.gov.br');

-- 8. Ecoponto Fátima
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(8, '08:00:00', '17:30:00', true, 'ecoponto.fatima@joinville.sc.gov.br');

-- 9. Ponto de Entrega Voluntária - Anita Garibaldi
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(9, '09:00:00', '16:00:00', false, 'pev.anitagaribaldi@joinville.sc.gov.br');

-- 10. Ecoponto Paranaguamirim
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(10, '07:30:00', '17:00:00', true, 'ecoponto.paranaguamirim@joinville.sc.gov.br');

-- 11. Ecoponto Costa e Silva
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(11, '08:00:00', '18:00:00', true, 'ecoponto.costaesilva@joinville.sc.gov.br');

-- 12. Ecoponto Atiradores
INSERT INTO locais_de_descarte (endereco_id, hora_inicio, hora_fim, faz_coleta, email) VALUES
(12, '07:00:00', '17:00:00', false, 'ecoponto.atiradores@joinville.sc.gov.br');

-- ITENS POR LOCAL DE DESCARTE
